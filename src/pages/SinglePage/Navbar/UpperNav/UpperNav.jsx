    ...
    <div className="w-full bg-[#fffaea] py-10 border-b">
      <div className="w-[96vw] mx-auto flex justify-between items-center">
        ...
        <div className="flex justify-between items-center w-2/12 relative">
          ...
          >
            <li className="text-xl font-bold mb-3 pb-2 text-gray-900">
              Account
            </li>
            ...
            <li className=" hover:text-amber-400 transition-all cursor-pointer text-start text-gray-900 border-b pb-2 mb-2">
              <Link to="/dashboard">Dashboard</Link>
            </li>
            <li
              className={
                loggedInUsersRole !== "cook"
                  ? "hidden"
                  : " hover:text-amber-400 transition-all cursor-pointer text-start border-b mb-2 pb-2 text-gray-900"
              }
            >
              <Link to="update_profile"> orders </Link>
            </li>
            <li
              className={
                loggedInUsersRole !== "cook"
            ...
            >
              <Link to="update_profile"> Adresses </Link>
            </li>
            <li
              className={
                loggedInUsersRole !== "cook"
            ...
            >
              <Link to="update_profile"> Payment Methods </Link>
            </li>
            <li
              className={
                loggedInUsersRole !== "cook"
            ...
            >
              <Link to="update_profile"> Returns & Refunds </Link>
            </li>
            <li className=" hover:text-amber-400 transition-all cursor-pointer text-start border-b mb-2 pb-2 text-gray-900">
              <Link to="/my_account"> Account Details </Link>
            </li>
            <li
              className={
                loggedInUsersRole !== "cook"
            ...
            <li
              ...
              className=" hover:text-amber-400 transition-all cursor-pointer text-start text-gray-900"
            >
              <Link to="/">Logout</Link>
            </li>
          </ul>
          <CiHeart
            className={`${
              loggedInUsersRole !== "customer"
                ? "hidden"
                : "text-3xl cursor-pointer hover:scale-110 transition-all"
            }`}
          />
          <FiShoppingCart
            className={`${
              loggedInUsersRole !== "customer"
                ? "hidden"
                : "text-2xl cursor-pointer hover:scale-110 transition-all"
            }`}
          />
          <div>
