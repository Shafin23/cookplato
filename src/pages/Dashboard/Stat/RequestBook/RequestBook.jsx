...
const RequestBook = ({ option }) => {
    ...
    }, [dataFetchTrigger, setDataFetchTrigger])
    // ==================================================
    ...
    return (
        <div className={option !== "request" && "hidden"}>
            ...
            {
                requestBook?.map(request => <div className=' flex justify-between items-center border-dashed border-b  py-4 px-3 rounded-xl hover:bg-amber-50 transition duration-200'>
                    {/* details show */}
